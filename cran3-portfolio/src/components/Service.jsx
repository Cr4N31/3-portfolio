...
function Service({ stacks: propStacks }) {
  ...
  return (
    <section
      id="services"
      className="px-4 md:px-12 lg:px-12 py-16"
      data-aos="fade-up"
    >
      <div>
        <h2 className="text-center text-[#ffed00] text-4xl font-semibold uppercase mb-8">
          SERVICES
        </h2>
          ...
          {[
            {
              ...
              desc: "Responsive, animated and conversion-optimized landing pages",
            },
            {
              title: "Speed Optimization",
              desc: "Boost your site's performance and load times.",
            },
            {
              title: "Web Templates",
              desc: "Custom HTML & Tailwind CSS templates for fast creation.",
            },
            {
              title: "Portfolio Websites",
              desc: "Modern personal websites for developers & freelancers.",
            },
          ].map((service) => (
            <div
              key={service.title}
              ...
              style={{
                ...
                border: "1px solid rgba(255, 238, 0, 0.09)",
                boxShadow:
            ...
            >
              {/* Hover glow */}
              <div
                className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition duration-300 pointer-events-none"
                style={{
                  background:
                    "radial-gradient(ellipse at top, rgba(255,237,0,0.07), transparent 70%)",
                }}
              />
              {/* Specular highlight */}
              <div
        ...
        <div className="mt-8" data-aos="fade-up">
          <h2 className="text-3xl font-semibold mb-4 text-[#ffed00] text-center uppercase mt-8">
            Tech Stack
          </h2>
          ...
          {[
            ...
            <div key={key}>
              <h4 className="text-2xl text-[#ffed00] uppercase mb-4">
                {label}
              </h4>
              <div
                className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-10 mb-12 py-12"
                data-aos={dir}
              >
                {(stacks[key] || []).map((s) => (
                  <div
                    ...
                    style={{
                      ...
                      border: "1px solid #ffee003a",
                      boxShadow: "inset 0 1px 0 rgba(255, 255, 255, 0.12)",
                    }}
                  >
                    <img
                      className="w-20 transition-transform duration-300 group-hover:scale-110"
                      src={s.src || placeholderIcon}
                      alt={s.name}
                    />
